...
//			 thisDto.setCreateUserName(user.getUserName());
	 ...
	 * @throws Exception
	 */
	public void save(MyUserPrincipal myUserPrincipal,WaybillSaveUpdateDto wsuDto, CommonsMultipartFile file) throws Exception {
		try {
...
//			 waybill.setCreateUser(session.getAttribute("username").toString());
			...
			if (myUserPrincipal != null && myUserPrincipal.getUser() != null) {
				createuserId = myUserPrincipal.getUser().getId();
			}
	 ...
	 * @throws Exception
	 */
	public void update(MyUserPrincipal myUserPrincipal,WaybillSaveUpdateDto wsuDto, CommonsMultipartFile file) throws Exception {
		try {
			...
			if (myUserPrincipal != null && myUserPrincipal.getUser() != null) {
				updateuserId = myUserPrincipal.getUser().getId();
			}
